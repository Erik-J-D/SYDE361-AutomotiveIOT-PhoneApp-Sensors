...
- (void)willActivate {
    ...
    pieChart.largeText = [[NSAttributedString alloc]  initWithString:@"Fuel Left" attributes:@{NSForegroundColorAttributeName : [UIColor whiteColor]}];
    pieChart.smallText = [[NSAttributedString alloc] initWithString:@"52" attributes:@{NSForegroundColorAttributeName : [UIColor whiteColor]}];
